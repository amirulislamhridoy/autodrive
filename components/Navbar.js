            ...
            <nav className=" max-w-7xl mx-auto border-gray-200 px-2 sm:px-4 py-2.5">
                <div className="container flex flex-wrap items-center justify-between mx-auto">
                    ...
                    <div className="flex lg:order-2">
                        {user?.email ? <button type="button" onClick={logoutFn} className="font-bold bg-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium px-5 py-2 text-center text-xs mr-3 lg:mr-0 dark:bg-blue-600 dark:focus:ring-blue-800 hover:scale-110 duration-300">LOG OUT</button> : <button type="button" onClick={() => router.push('/login')} className="font-bold bg-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium px-5 py-2 text-center text-xs mr-3 lg:mr-0 dark:bg-blue-600 dark:focus:ring-blue-800 hover:scale-110 duration-300">LOGIN</button>}
